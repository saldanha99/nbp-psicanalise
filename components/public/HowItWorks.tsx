...
const steps = [
  {
    ...
    label: 'Explore',
    title: 'ESCOLHA\nSEU\nCURSO',
    body: 'Navegue pelo nosso catálogo com mais de 24 cursos infláveis e eletrônicos. Filtre por categoria, capacidade e faixa etária para encontrar o perfeito para o seu evento.',
    bg: '#FFFFFF',
    color: '#0F172A',
  ...
  },
  {
    ...
    label: 'Celebre',
    title: 'DIVERSÃO\nGARANTIDA',
    body: 'Relaxe e curta o evento. Nossos monitores cuidam da operação dos cursos do início ao fim. Depois, desmontamos tudo sem deixar rastro. Simples assim.',
    bg: '#F5F0E8',
    color: '#0F172A',
    divider: 'rgba(15,23,42,0.15)',
  },
